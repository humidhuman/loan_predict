...
text_input[5] = st.text_input("Какой у Вас месячный доход в рублях?", "Нужно ввести количество")
text_input[6] = st.text_input("Какой у Вашего созаявителя месячный доход в рублях?", "Нужно ввести количество")
text_input[7] = st.text_input("Cколько рублей вы хотели бы взять?", "Нужно ввести количество")
text_input[8] = st.text_input("На сколько дней хотели бы взять займ?", "Нужно ввести количество")
